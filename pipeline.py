...
project = Project(
    title="FriendFeed Discovery",
    project_html="""
        <img class="project-logo" alt="Project logo" src="http://archiveteam.org/images/c/c9/Logo.png" height="50px" title=""/>
        <h2>FriendFeed Phase 1.
        <span class="links">
             <a href="http://friendfeed.com/">Website</a> &middot;
             <a href="http://tracker.archiveteam.org/friendfeeddisco/">Leaderboard</a>
             <a href="http://archiveteam.org/index.php?title=FriendFeed">Wiki</a> &middot;
         </span>
        </h2>
        <p>FriendFeed is shutting down. This is phase 1: content discovery.</p>
    """,
...
pipeline = Pipeline(
    ...
    GetItemFromTracker("http://%s/%s" % (TRACKER_HOST, TRACKER_ID), downloader,
        VERSION),
    PrepareDirectories(warc_prefix="friendfeeddisco"),
